namespace GleyEasyIAP
{
    ...
    public class IAPSettingsWindow : EditorWindow
    {
        ...
        [MenuItem("Window/Gley/Easy IAP")]
        static void Init()
        {
            // Get existing open window or if none, make a new one:
            IAPSettingsWindow window = (IAPSettingsWindow)GetWindow(typeof(IAPSettingsWindow), true, "Easy IAP Settings Window - v1.2.0");
